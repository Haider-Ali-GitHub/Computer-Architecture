...
void recursiveMatTrans (
    ...
    recursiveMatTrans(global_n, n/2, A, offset_row_A, offset_col_A, B, offset_row_B, offset_col_B);
    recursiveMatTrans(global_n, n/2, A, offset_row_A + n/2, offset_col_A + n/2, B, offset_row_B + n/2, offset_col_B + n/2);
    recursiveMatTrans(global_n, n/2, A, offset_row_A, offset_col_A + n/2, B, offset_row_B + n/2, offset_col_B);
    recursiveMatTrans(global_n, n/2, A, offset_row_A + n/2, offset_col_A, B, offset_row_B, offset_col_B + n/2);
